...
public interface ConditionBuilder<T> extends Serializable {
    ...
    default <LEFT, RIGHT> T eq(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.EQ, left, right);
    }
    ...
    default <LEFT, RIGHT> T ne(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.NE, left, right);
    }
    ...
    default <LEFT, RIGHT> T gt(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.GT, left, right);
    }
    ...
    default <LEFT, RIGHT> T ge(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.GE, left, right);
    }
    ...
    default <LEFT, RIGHT> T lt(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.LT, left, right);
    }
    ...
    default <LEFT, RIGHT> T le(SerializableFunction<LEFT, ?> left, SerializableFunction<RIGHT, ?> right) {
        return this.apply(true, ConditionType.EQ, left, right);
    }
